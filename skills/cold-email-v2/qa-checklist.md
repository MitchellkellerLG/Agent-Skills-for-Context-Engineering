...
**Target: 40-80 words (tighter is better)**
...
- Em-dashes look sales-y and can trigger spam filters
...
**Punctuation:**
1. Replace "—" with ". " or ", " (em-dashes are not allowed)
2. Replace "–" with ". " or ", " (en-dashes are not allowed)
3. Replace "--" with ". " or ", " (double hyphens are not allowed)
4. Trim double spaces globally
...
| **40-80 words (strict)** | ☐ Pass ☐ Fail | |
| No links in first email | ☐ Pass ☐ Fail | |
| Uses sensory see/feel/touch language | ☐ Pass ☐ Fail | |
| CTA is low-effort | ☐ Pass ☐ Fail | |
| Reads in under 20 seconds | ☐ Pass ☐ Fail | |
| No em-dashes used | ☐ Pass ☐ Fail | |
| Subject line 2-4 words (or whole offer) | ☐ Pass ☐ Fail | |
| "Would I reply?" test = YES | ☐ Pass ☐ Fail | |
| **Email 2 uses casual opener** | ☐ Pass ☐ Fail | e.g., "Oh totally forgot to mention" |
...
☐ Word count: ____ (target 40-80)
☐ CTA = low-effort
☐ Reads naturally aloud
☐ No em-dashes used (use periods/commas instead)
☐ Subject line = 2-4 words OR whole offer
☐ "Would I reply?" = YES
☐ Email 2 uses casual opener (e.g., "Oh totally forgot to mention")
